package com.managerworkspace.exception.handler;

import com.managerworkspace.dto.response.ErrorResponse;
...
public class CustomExceptionHandler {
  ...
  @ExceptionHandler(LoanDecisionNotFoundException.class)
  @ResponseStatus(HttpStatus.NOT_FOUND)
  public ResponseEntity<ErrorResponse> handleLoanDecisionNotFoundException(
      LoanDecisionNotFoundException e) {
    ErrorResponse response =
        new ErrorResponse(
            HttpStatus.NOT_FOUND.value(), HttpStatus.NOT_FOUND.getReasonPhrase(), e.getMessage());
    return new ResponseEntity<>(response, HttpStatus.NOT_FOUND);
